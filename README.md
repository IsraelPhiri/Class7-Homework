To run the code, copy and paste the code or open the code in a compiler like pycharm.The scatter plot shows me the class as clearly continuos and hence I can go ahead and use Logistic Regression.
